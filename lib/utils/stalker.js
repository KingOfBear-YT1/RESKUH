...
async function stalkml(text) {
  var datap = {
    ...
    "order.data.profile": "",
    "user.userId": text1,
    "user.userServer": text2,
    "voucherTypeName": "MOBILELEGENDS",
    "affiliateTrackingId": "",
    "impactClickId": "",
    "checkoutId": "",
    "tmwAccessToken": "",
...
module.exports = { twitterStalk, instagramStalk, tiktokStalk, npmStalk, githubStalk, tgstat, stalkff, stalkml }